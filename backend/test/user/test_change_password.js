...
describe('Test Change Password', () => {
    ...
    describe('Change password with invalid auth', () => {
    ...
    describe('Change password with correct info', () => {
        it('Should return 200', (done) => {
            ...
            chai.request(server)
                ...
                .send(info)
                .end((err, res) => {
                    res.body.should.have.property('message','User password successfully updated.');
